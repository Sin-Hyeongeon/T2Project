...
public class MemberMapperTests {
	 ...
	 * MemberVO();
	 * 
	 * member.setMember_id("spring_test"); member.setPass("spring_test");
	 * member.setMember_name("spring_test"); member.setAddress("spring_test");
	 * member.setAddress2("spring_test"); member.setAddress3("spring_test");
	 * member.setEmail("spring_test"); member.setActive("Y");
	 * member.setMoney(10000); member.setAdminck(0);
	 * 
