...
<body class="bg-white">
				...
				<div class="m-5">
					...
					<div class="form-group">
						<label>글번호</label> <input class="form-control" name='qna_no'
							value='<c:out value="${qna.qna_no }"/>' readonly="readonly">
					</div>
					...
					<div class="form-group">
						<label>작성자</label> <input class="form-control" name='member_id'
							value='<c:out value="${qna.member_id }"/>' readonly="readonly">
					</div>
					...
					<form id='operForm' action="/qna/modify" method="get">
						<input type='hidden' id='qna_no' name='qna_no'
							value='<c:out value="${qna.qna_no }"/>'> <br>
					</form>
				</div>
	...
	<form id="operForm" action="/qna/modify" method="get">
		<input type="hidden" id="qna_no" name="qna_no"
			value='<c:out value="${qna.qna_no }"/>'> <input type="hidden"
