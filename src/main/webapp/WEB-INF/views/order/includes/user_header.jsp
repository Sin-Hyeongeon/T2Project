...
.header__menu .hero__search {
	margin-bottom: 0px;
}

.header__menu .hero__search .hero__search__form {
	width: 523px;
}

.header__menu .hero__search .hero__search__categories {
	width: 24%;
}
</style>
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="header__logo" align="right">
					<a href="/"><img src="/resources/img/logo2.png" alt=""
			...
			<div class="col-lg-5">
				<div class="header__top__right">
					<div class="header__top__right__social">
						<a href="/member/join"><i class="fa fa-se"><span
								style="color: green">회원가입</span></i> </a>
					</div>
					...
					<div class="header__top__right__auth">
						<c:if test="${ member != null }">
							<div class="login_success_area">
								<span>회원 : ${member.member_name}</span> <a
				...
				<div class="col-lg-7">
					<nav class="header__menu p-2 m-2 text-top shadow-none">
						<ul>
							...
							<li><a href="/cart/${member.member_id }"><i
									class="fa fa-shopping-bag w-100 h-100"></i></a></li>
					...
					<div id="wrap align-self-stretch">
						<form action="" autocomplete="on">
							<input id="search" name="search" type="text"
								placeholder="찾으시는 제품명을 입력해주세요"> <input
