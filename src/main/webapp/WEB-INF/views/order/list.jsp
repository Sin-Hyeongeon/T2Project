							...
							<table>
								...
								<tbody>
									<tr>
										...
										<td class="shoping__cart__quantity"><input type="text"
											class="quantity_input" value="1"> <span> <b>1<b></b></span>
							...
							<div class="shoping__checkout bg-white">
								...
								<ul>
									...
									<div class="form-group">
										<label>성명</label> <input class="form-control"
											name='meber_name' readonly="readonly">
									</div>
						...
						<div class="col-lg-6 bg-white">
							<div class="shoping__checkout bg-white">
								...
								<ul>
									...
									<div class="form-group">
										<label>배송지</label> <input class="form-control"
						...
						<div class="shoping__checkout bg-white">
							...
							<ul>
								...
								<li><div class="text-danger" align="center"
										style="font-size: 20px">$454.98</div></li>
...
<div class="button">
	<div class="button_quantity">
		주문수량 <input type="text" class="quantity input" value="1"> <span>
