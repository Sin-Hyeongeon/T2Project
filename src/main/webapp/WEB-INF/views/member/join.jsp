		...
		<div class="col-5 mx-auto">
			<div class="container-fluid">
				...
				<div class="form-group mail_check_wrap">
					...
					<button type="button" class="btn btn-outline-dark mail_check_button">
						<span>인증번호 전송</span>
					</button>
			...
			<div class="form-group address_wrap">
				...
				<div class="address_input_1_wrap">
					<div class="address_input_1_box">
						<input class="form-control address_input_1" name="address" readonly="readonly">
					</div>
					<button type="button" class="btn btn-outline-dark address_button" onclick="execution_daum_address()">
						<span>주소 찾기</span>
					</button>
				...
				<span class="final_addr_ck text-danger">주소를 입력해주세요.</span>
							...
							<div class="mx-auto join_button_wrap" align="center">
								...
								<button type="button" onclick = "location.href='/'" class="btn btn-outline-secondary">목록</button>
							</div>
							<br>
