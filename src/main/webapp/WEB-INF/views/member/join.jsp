...
<body class="bg-white">
	<div class="row bg-white">
		<div class="col-lg-12">
			<h2 align="center" class="page-header">회원 가입</h2>
				...
				<form id="join_form" method="post">
					...
					<div class="form-group id_wrap">
						...
						<span class="id_input_re_1">사용 가능한 아이디입니다.</span> <span
							class="id_input_re_2 text-danger">아이디가 이미 존재합니다.</span> <span
							class="final_id_ck text-danger">아이디를 입력해주세요.</span>
					</div>
					...
					<div class="form-group pwck_wrap">
						...
						<span class="final_pwck_ck text-danger">비밀번호 확인을 입력해주세요.</span> <span
					...
					<div class="form-group mail_wrap">
						...
						<div class="form-group mail_check_wrap">
							...
							<button type="button"
								class="btn btn-outline-dark mail_check_button">
								<span>인증번호 전송</span>
							</button>
					...
					<div class="form-group address_wrap">
						...
						<div class="address_input_1_wrap">
							<div class="address_input_1_box">
								<input class="form-control address_input_1" name="address"
									readonly="readonly">
							</div>
							<button type="button" class="btn btn-outline-dark address_button"
						...
						<div class="form-group address_input_2_wrap">
							<div class="address_input_2_box">
								<input class="form-control address_input_2" name="address2"
									readonly="readonly">
							</div>
						</div>

						<div class="form-group address_input_3_wrap">
							<div class="address_input_3_box">
								<input class="form-control address_input_3" name="address3"
									readonly="readonly">
							</div>
						</div>
					...
					<br>
					<div class="mx-auto join_button_wrap" align="center">
						<button type="button" class="btn btn-outline-success join_button">가입하기</button>
